#!/usr/bin/env python3
"""
Debug version of main.py with extra window visibility controls
"""
...
class DatasetAnalyzerApp(QMainWindow):
    ...
    def init_ui(self):
        ...
        print("Window title: Dataset Analyzer")
...
def main():
    print("=== Dataset Analyzer Desktop Application (Debug Mode) ===")
    ...
    print("Look for 'Dataset Analyzer' in your taskbar or press Alt+Tab")
    
    # Show a message box to confirm the app is running
    msg = QMessageBox()
    msg.setWindowTitle("App Started")
