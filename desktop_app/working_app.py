#!/usr/bin/env python3
"""
Working version that combines simple UI with real backend connectivity
"""
...
class DatasetAnalyzerApp(QMainWindow):
    ...
    def init_ui(self):
        self.setWindowTitle("Chemical Equipment Parameter Visualizer - Working Version")
...
def main():
    print("=== Chemical Equipment Parameter Visualizer - Working Version ===")
    print("Starting application with real Django backend integration...")
    
    app = QApplication(sys.argv)
    app.setApplicationName("Chemical Equipment Parameter Visualizer - Working")
    app.setStyle('Fusion')
    ...
    print("This version includes real Django backend connectivity")
